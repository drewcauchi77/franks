...
<p><?php _e( 'Your order is on-hold until we confirm stock availability. Your order details are shown below for your reference:', 'woocommerce' ); ?></p><?php // phpcs:ignore WordPress.XSS.EscapeOutput ?>
