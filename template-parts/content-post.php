 ...
 * @package franks
 */
if (has_category($category = 'Wine Boutique', $post->ID)) { 
    $customMessage = 'Go back to Gentlemen\'s Essentials';
    $customLink = get_stylesheet_directory_uri() . "/gentlemens-essentials";
}else if(has_category('Uncategorized', $post->ID) !== true){
    $category_details = get_the_category($post->ID);
    $category_name = $category_details[0]->name;
    $category_slug = $category_details[0]->slug;
    
    $customMessage = 'Go back to ' . $category_name;
    $customLink = "https://franks.com.mt/product-category/brands/" . $category_slug;
}else {
    $customMessage = 'Go back to News & Promotions';
    $customLink = get_stylesheet_directory_uri() . "/news-promotions";
}
?>

<?php include(dirname(__FILE__)."/../page-templates/back-to-home.php"); ?>
            ...
            <div class="social-container wishlist">
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo get_the_permalink(); ?>" target="_blank">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 96 96" style="enable-background:new 0 0 96 96;" xml:space="preserve" width="30px" height="30px">
                        <g>
                            <path d="M48,0C21.49,0,0,21.49,0,48c0,26.511,21.49,48,48,48s48-21.489,48-48C96,21.49,74.51,0,48,0z    M59.369,33.17h-7.217c-0.854,0-1.805,1.121-1.805,2.623v5.211h9.021v7.428h-9.021v22.306h-8.52V48.432h-7.723v-7.428h7.723v-4.372   c0-6.269,4.352-11.368,10.324-11.368h7.217L59.369,33.17L59.369,33.17z" fill="#f1f2f2"/>
                        </g>
                    </svg>
                </a>
                ...
                <a href="https://plus.google.com/share?url=<?php echo get_the_permalink(); ?>" target="_blank">
                    ...
                    <path fill="#f1f2f2" d="M110,0C49.249,0,0,49.247,0,110s49.249,110,110,110s110-49.247,110-110S170.75,0,110,0z M137.625,110
                ...
                <a href="https://pinterest.com/pin/create/button/?url=<?php echo get_the_permalink(); ?>&media=<?php echo $large_image; ?>&description=" target="_blank">
                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"             y="0px"
                         ...
                         xml:space="preserve">
                    <g>
                        <path fill="#f1f2f2" d="M266.667,0C119.391,0,0,119.391,0,266.667c0,147.275,119.388,266.666,266.667,266.666
