...
$parts = parse_url($youtube_video);
parse_str($parts['query'], $query);
$video_id = $query['v'];

$embed_src = 'https://www.youtube.com/embed/' . $video_id . '?autoplay=0&showinfo=0&modestbranding=1&rel=0';

$products_used = get_field('products_used');

?>

<div class="home-banner-cont feat-banner-cont how-to-container">
        ...
        <div class="how-to-grid">
            <div class="how-to-video">
                <div class="video-wrapper">
                    <iframe width="560" height="315" src="<?php echo $embed_src; ?>" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
            <div class="products-used woocommerce">
            
            <?php if ($products_used): ?>
                <h4 style="margin: 0">Products Used</h4>
                <div class="products-list">
                    <ul class="products">
                
                    <?php global $woocommerce;
                        foreach ($products_used as $post): ?>
                        
                        <?php setup_postdata($post); ?>
                        <?php set_query_var( 'custom_post', 'video' ); ?>
...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="page-container single-how-to">
