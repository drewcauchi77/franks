...
?>
	...
	<div id="primary" class="content-area">
		...
		<main id="main" class="site-main brand-page" role="main">

			<?php 
			$customLink = '/news-promotions';
			$customMessage = 'Go back to <b>News & Promotions</b>';

			include 'page-templates/back-to-home.php'; ?>

			<div class="page-container brand-container">

				<div class="brand-section brand-image">
				...
				<div class="brand-section brand-description">
				...
				<div class="brand-section social-links">
